// Parse UTA GTFS data and extract a lightweight bus overlay for Salt Lake City.
...
const gtfsDir = join(__dirname, "..", "gtfs_slc");
const outputPath = join(__dirname, "..", "src", "data", "slcBusRoutesTest.json");
...
function main() {
  console.log("Parsing SLC GTFS bus routes...");
