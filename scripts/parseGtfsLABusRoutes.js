// Parse LA Metro bus GTFS data and extract a lightweight bus overlay for Los Angeles.
...
const gtfsDir = join(__dirname, "..", "gtfs_la_bus");
const outputPath = join(__dirname, "..", "src", "data", "laBusRoutesTest.json");
...
function main() {
  console.log("Parsing LA Metro GTFS bus routes...");
