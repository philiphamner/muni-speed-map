// Parse Boston MBTA GTFS data and extract Green Line and Mattapan Trolley stops as GeoJSON
...
// MBTA Green Line branches + Mattapan Trolley
...
function main() {
  ...
  console.log(`Found ${greenStops.length} stops serving Green Line and Mattapan`);
