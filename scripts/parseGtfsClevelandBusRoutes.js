// Parse GCRTA GTFS data and extract a lightweight bus overlay for Cleveland.
import { readFileSync, writeFileSync } from "fs";
import { join, dirname } from "path";
import { fileURLToPath } from "url";

const __dirname = dirname(fileURLToPath(import.meta.url));
const gtfsDir = join(__dirname, "..", "gtfs_cleveland");
const outputPath = join(__dirname, "..", "src", "data", "clevelandBusRoutesTest.json");
...
function main() {
  console.log("Parsing Cleveland GTFS bus routes...");
