// Parse MBTA GTFS data and extract a lightweight bus overlay for Boston.
...
const outputPath = join(__dirname, "..", "src", "data", "bostonBusRoutesTest.json");
...
function main() {
  console.log("Parsing Boston GTFS bus routes...");
