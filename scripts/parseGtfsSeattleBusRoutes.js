// Parse Seattle GTFS data and extract a lightweight bus overlay.
...
const kcmGtfsDir = join(__dirname, "..", "gtfs_seattle_kcm");
const soundTransitGtfsDir = join(__dirname, "..", "gtfs_seattle");
const gtfsDir = existsSync(join(kcmGtfsDir, "routes.txt"))
  ? kcmGtfsDir
  : soundTransitGtfsDir;
...
function main() {
  console.log(`Parsing Seattle GTFS bus routes from ${gtfsDir}...`);
