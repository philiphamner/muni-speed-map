// Parse MDOT MTA Baltimore local bus GTFS data and extract a lightweight bus overlay.
...
const gtfsDir = join(__dirname, "..", "gtfs_baltimore_bus");
const outputPath = join(
  __dirname,
  "..",
  "src",
  "data",
  "baltimoreBusRoutesTest.json",
);
...
function main() {
  console.log("Parsing Baltimore local bus GTFS routes...");
