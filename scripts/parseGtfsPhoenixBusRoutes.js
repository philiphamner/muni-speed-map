// Parse Valley Metro GTFS data and extract a lightweight bus overlay for Phoenix.
...
const gtfsDir = join(__dirname, "..", "gtfs_phoenix");
const outputPath = join(__dirname, "..", "src", "data", "phoenixBusRoutesTest.json");
...
function main() {
  console.log("Parsing Phoenix GTFS bus routes...");
