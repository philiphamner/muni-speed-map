// Parse TTC GTFS data and extract a lightweight bus overlay for Toronto.
...
const outputPath = join(__dirname, "..", "src", "data", "torontoBusRoutesTest.json");
...
function main() {
  console.log("Parsing Toronto GTFS bus routes...");
