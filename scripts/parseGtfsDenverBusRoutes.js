// Parse RTD GTFS data and extract a lightweight bus overlay for Denver.
...
const outputPath = join(__dirname, "..", "src", "data", "denverBusRoutesTest.json");
...
function main() {
  console.log("Parsing Denver GTFS bus routes...");
  ...
  Object.entries(candidatesByRouteDir).forEach(([routeDirKey, byShape]) => {
    ...
    selectedShapes[shapeId] = { ...info, route_dir_key: routeDirKey };
  });
