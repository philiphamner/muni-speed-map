// Parse VTA GTFS data and extract a lightweight bus overlay for San Jose testing.
...
const gtfsDir = join(__dirname, "..", "gtfs_vta");
const outputPath = join(__dirname, "..", "src", "data", "vtaBusRoutesTest.json");
...
function main() {
  console.log("Parsing VTA GTFS bus routes...");
